...
SetDirectory["Z:\\Users\\Pete\\SimulatorSimulator\\Simulator\\MathematicaScripts\\TrapData\\BladeTrap"]
...
(* Potentials are exported in volts. *)
...
\[CapitalOmega] = 2\[Pi] *50.0 10^6; (* RF drive frequency *)
(*Vrf:=1000;*) 
DCMax:=2500;
...
Quiet[
DCxy[x_,y_,z_,t_] :=DC1[t]*DC1xy[x,y,0]+RF1[t]*RF1xy[x,y,0] ;
DCzx[x_,y_,z_,t_] :=DC1[t]*DC1zx[x,0,z]+RF1[t]*RF1zx[x,0,z] ;
DCzy[x_,y_,z_,t_] :=DC1[t]*DC1zy[0,y,z]+RF1[t]*RF1zy[0,y,z];  
]
...
Export["Z:\\Users\\Pete\\SimulatorSimulator\\Simulator\\TempFiles\\secular_frequencies_blade.csv", SecularFrequencies];
